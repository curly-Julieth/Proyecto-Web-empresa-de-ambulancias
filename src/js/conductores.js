...
function activarFormulario() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (!cedula) {
      document.getElementById("errorCedula").textContent = "Ingrese la cédula";
      hayError = true;
    }

    if (!whatsapp) {
      document.getElementById("errorWhatsapp").textContent = "Ingrese WhatsApp";
      hayError = true;
    }
    ...
    if (!licencia) {
      document.getElementById("errorLicencia").textContent = "Ingrese licencia";
      hayError = true;
    }
